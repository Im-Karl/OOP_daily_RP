...
// Cái này chạy oke cái kia là fixx
public class MainBug {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 13 -> searchVehicle4(list);
			case 14 -> addFuelList(fuellist);
			case 15 -> addStationList(stationList);
			case 16 -> addBrandList(brandList);
			case 17 -> addTyreList(tyreList);
//			case 16 -> addFuelList(fuellist); nên xem lại? tại sao lại làm list giá có thể làm list giá nhưng khi thêm phương tiện thì list giá tự động thêm thì được
			case 18 -> fuellist.displayFuel();
			case 19 -> stationList.displayStation();
			case 20 -> brandList.displayBrand();
			case 21 -> tyreList.displayTyre();
			case 22 -> removeFuelList(fuellist);
			case 23 -> removeStationList(stationList);
			case 24 -> removeBrandList(brandList);
			case 25 -> removeTyreList(tyreList);
